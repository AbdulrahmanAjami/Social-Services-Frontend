...
const Contact = () => {
  ...
  const contactInfo = [
    { icon: Phone,  title: 'الهاتف',             value: '0787077828',          link: 'tel:+96261234567',           color: 'from-emerald-500 to-teal-600' },
    { icon: Mail,   title: 'البريد الإلكتروني', value: 'info@participate.org', link: 'mailto:info@participate.org', color: 'from-teal-500 to-cyan-600'    },
          ...
          <div className="overflow-hidden rounded-3xl border border-slate-100 bg-white shadow-sm">
            ...
            <div className="p-6 md:p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div>
                  <label className="mb-1.5 block text-sm font-bold text-slate-700">الاسم الكامل <span className="text-red-500">*</span></label>
                ...
                <div>
                  <label className="mb-1.5 block text-sm font-bold text-slate-700">البريد الإلكتروني <span className="text-red-500">*</span></label>
                ...
                <div>
                  <label className="mb-1.5 block text-sm font-bold text-slate-700">رقم الهاتف <span className="text-slate-400 font-normal">(اختياري)</span></label>
                ...
                <div>
                  <label className="mb-1.5 block text-sm font-bold text-slate-700">الموضوع <span className="text-slate-400 font-normal">(اختياري)</span></label>
                  <input type="text" value={formData.subject} placeholder="موضوع الرسالة"
                    onChange={(e) => setFormData({ ...formData, subject: e.target.value })} className={INPUT} />
                </div>
                <div>
                  <label className="mb-1.5 block text-sm font-bold text-slate-700">الرسالة <span className="text-red-500">*</span></label>
                ...
                <button type="submit" disabled={loading}
                  ...
                  {loading ? <><ButtonSkeleton /> جاري الإرسال...</> : <><Send className="size-5" /> إرسال الرسالة</>}
                </button>
              </form>
            </div>
          </div>
